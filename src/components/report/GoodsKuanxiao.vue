  ...
  <div id="report_goods_kuanxiao">
      ...
      <div class="search-condition">
        <el-row :gutter="25">
          <div v-if="is_diamond">
            <el-col :span="6">
              <div class="search-main">
                <span class="search-text">主钻分数:</span>
            ...
            <el-col :span="6">
              <div class="search-main">
                <span class="search-text">钻石净度:</span>
            ...
            <el-col :span="6">
              <div class="search-main">
                <span class="search-text">主石名称:</span>
          ...
          <div v-else>
            <el-col :span="6">
              <div class="search-main">
                <span class="search-text">主石评级:</span>
            ...
            <el-col :span="6">
              <div class="search-main">
                <span class="search-text">颜色:</span>
            ...
            <el-col :span="6">
              <div class="search-main">
                <span class="search-text">规格:</span>
          ...
          <el-col :span="6">
            <div class="search-main" style="visibility:hidden">
              ...
              <el-date-picker class="search-input" format="yyyy年MM月dd日" value-format="yyyy-MM-dd" type="date" placeholder="选择日期">
              </el-date-picker>
            </div>
          </el-col>
          <!-- ///////////////// -->
    ...
    <div class="search-table">
      <el-table :data="tableData" stripe align="center">
        ...
        <el-table-column align="center" label="订单数量" prop="order"></el-table-column>
        <el-table-column align="center" label="净订单数量" prop="clear_order"></el-table-column>
        <el-table-column align="center" label="退款订单数量" prop="refund_order"></el-table-column>
        ...
        <el-table-column align="center" label="净销总金额" prop="clear_money"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    async loadData() {
      ...
      let result = await this.$axios.get("/admin/report/kuanxiao_goods", {
        params: search
      });
