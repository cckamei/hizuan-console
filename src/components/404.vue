<template>
  <div class="http404-container">
    <div class="http404">
      ...
      <div class="bs">
        <div class="bs__oops">OOPS!</div>
        <div class="bs__headline">{{ message }}</div>
        <div class="bs__info">请检查您输入的网址是否正确，或点击以下按钮返回主页</div>
        <div>
          <a href="" class="bs__return-home">返回首页</a>
        </div>
      </div>
    </div>
  </div>
