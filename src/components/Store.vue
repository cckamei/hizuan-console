  ...
  <div id="store">
    <div class="search-box">
        ...
        <el-row :gutter="25">
          <el-col :span="6">
            <div class="search-main">
              <span class="search-text">门店名称</span>
              <el-input class="search-input" v-model="search.name" placeholder="按门店名称搜索"></el-input>
            </div>
          </el-col>

          <el-col :span="6">
            <div class="search-main">
              <span class="search-text">门店地址</span>
              <el-input class="search-input" v-model="search.address" placeholder="按门店地址搜索"></el-input>
            </div>
          </el-col>
          ...
          <el-col :span="6">
            <div class="search-main">
              ...
              <el-input class="search-input" v-model="search.manager" placeholder="按负责人搜索"></el-input>
            </div>
          </el-col>
          ...
          <el-col :span="6">
            <div class="search-main">
              ...
              <el-input class="search-input" v-model="search.phone" placeholder="按负责人联系方式搜索"></el-input>
            </div>
          </el-col>
      ...
      <div class="search-btn">
        ...
        <el-button cricle type="primary" @click="add_line">新增门店</el-button>
      </div>
    </div>
    ...
    <el-dialog title="编辑门店" :visible.sync="dialogShow" width="30%">
      <el-form label-width="120px">
        <el-form-item label="门店名称:">
          <el-input class="added-input" v-model="added.name"></el-input>
        </el-form-item>
        <el-form-item label="门店地址:">
          <el-cascader class="added-input" :options="regionData" v-model="added.regionData" @change="handleChange">
          </el-cascader>

        </el-form-item>
        <el-form-item>
          <el-input class="added-input" v-model="added.address" placeholder="街道地址门牌号..."></el-input>
        </el-form-item>
  ...
  export default {
    ...
    methods: {
      async sureAdd() {
        ...
        if(this.added.id) {
          let result = await this.$axios.post(`/admin/store/${storeId}`, store);
          ...
          let result = await this.$axios.post("/admin/store", store);
          if(result.data.status != 0) return;
          this.added = {};
          this.$message("新增成功");
          this.dialogShow = false;
      ...
      async delete_store(index, rows) {
        ...
        if(store_id) {
          let resp = await this.$axios.delete(`/admin/store/${store_id}/`);
          rows.splice(index, 1);
        } else {
          rows.splice(index, 1);
        }
      ...
      async get_stores() {
        ...
        let resp = await this.$axios.get("/admin/store/", { params: params });
